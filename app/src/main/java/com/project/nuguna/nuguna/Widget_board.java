...
/**
 * Created by kwon on 2017-01-12.
 */

public class Widget_board {
    private int wbno;
    ...
    public Widget_board(int wbno, String email, String writer, String content, String inputdate, String wbtype,
